...
def test_daily_brief_includes_a_b_c_events(tmp_path):
    ...
    insert_decided_event(db_path, "A 级视频 Agent 事件", "A", "publish_article", event_date="2026-05-07")
    insert_decided_event(db_path, "B 级千问语音事件", "B", "daily_brief_only", event_date="2026-05-07")
    insert_decided_event(db_path, "C 级论文事件", "C", "update_assets_only", event_date="2026-05-07")
