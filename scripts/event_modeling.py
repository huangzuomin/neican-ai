...
def model_events(
    ...
    with get_conn(db_path) as conn:
            ...
            try:
                ...
                conn.execute(
                    ...
                    (
                        ...
                        event_type,
                        row["published_at"],
                        json.dumps(entities if isinstance(entities, list) else [], ensure_ascii=False),
        ...
        result = EventModelingResult(modeled_count, failed_count)
