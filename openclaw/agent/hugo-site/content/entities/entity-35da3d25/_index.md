...
<h1>英特尔</h1>
<p class="page-lead">英特尔 是 neican.ai 追踪的 AI 行业公司。</p>
<section class="entity-signal"><h2>当前信号</h2>
<p>英特尔 最近出现在“36氪首发 | 清华系AI Infra厂商完成数亿元融资，以GPU为核心重构计算机系统架构”中，事件类型为 tool_launch；当前主要关联 rag、llm、ai-agents，已沉淀 20 个相关事件。</p></section>
<section><h2>关联主题</h2><div class="entity-topic-chips"><a href="/topics/rag/">#rag</a><a href="/topics/llm/">#llm</a><a href="/topics/ai-agents/">#ai-agents</a><a href="/topics/ai-safety/">#ai-safety</a><a href="/topics/multimodal/">#multimodal</a><a href="/topics/mcp/">#mcp</a></div></section>
<section><h2>相关时间线/事件</h2><div class="entity-event-list">
<article><time>2026-05-08</time><span class="chip">tool_launch</span><h3>36氪首发 | 清华系AI Infra厂商完成数亿元融资，以GPU为核心重构计算机系统架构</h3><p>作者 | 乔钰杰
...
<article><time>2026-04-29</time><span class="chip">other</span><h3>Intel Earnings, Intel’s Differentiation?, Whither Terafab</h3><p>Intel's earnings were very impressive, but the chief driver was a structural shift in demand for CPUs for AI. Plus, what is going on with Terafab?</p></article>
...
<article><time>2026-04-03</time><span class="chip">model_release</span><h3>Gemma 4 and what makes an open model succeed</h3><p>Having written a lot of model release blog posts, there’s something much harder about reviewing open models when they drop relative to closed models, especially in 2026. In recent years, there were so few open models, so when
Llama 3
was released most people were still doing research on Llama 2 and </p></article>
<article><time>2026-04-02</time><span class="chip">model_release</span><h3>Gemma 4: Byte for byte, the most capable open models</h3><p>Gemma 4: Our most intelligent open models to date, purpose-built for advanced reasoning and agentic workflows.</p></article>
<article><time>2026-03-30</time><span class="chip">model_release</span><h3>Import AI 451: Political superintelligence; Google’s society of minds, and a robot drummer</h3><p>Welcome to Import AI, a newsletter about AI research. Import AI runs on arXiv and feedback from readers. If you’d like to support this, please subscribe.
...
硬氪获悉，北京容芯致远科技有限公司（以下简称“容芯致远”）近日完成天使轮数亿元融资</span></p>
<p><span>本轮由北京绿色能源和低碳产业基金与赛富投资基金领投，顺禧基金、富华资本、万利达集团、长江创新投、水木清华校友基金、梅花创投等跟投</span></p>
...
<p><span>Gemma 4: Our most intelligent open models to date, purpose-built for advanced reasoning and agentic workflows</span></p>
<p><span>1 Flash-Lite is our fastest and most cost-efficient Gemini 3 series model yet</span></p>
<p><span>Gemini 3 Flash offers frontier intelligence built for speed at a fraction of the cost</span></p>
<p><span>Game Arena is a new, open-source platform for rigorous evaluation of AI models</span></p>
<p><span>It allows for head-to-head comparison of frontier systems in environments with clear winning conditions</span></p>
