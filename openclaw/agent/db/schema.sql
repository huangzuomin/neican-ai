...
-- Event Store: multi-source merge evidence
...
-- Entity Registry: normalized entity names across all events
...
-- Topic Registry: structured topic metadata
...
-- Insight Candidates: track-accumulated evidence triggers
...
-- Routed full-text requests for main agent → info-fetcher.
...
CREATE INDEX IF NOT EXISTS idx_info_fetch_requests_status
ON info_fetch_requests(status);
