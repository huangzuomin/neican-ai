...
slug: 2026-05-19-datasette-llm-0-1a8-288
type: event
event_type: 模型/产品变化
entities: []
topics:
...
timeline:
  ...
  year: '2026'
seo:
  description: 'Release: datasette-llm 0.1a8 Fix for bug where llm_prompt_context()
    hook did not fully collect chains of responses. #7'
---
...
- 1a8 Fix for bug where llm_prompt_context() hook did not fully collect chains of responses
